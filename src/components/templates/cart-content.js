        ...
        <ColumnContent>
          ...
          <Link className="back-link" href='/sklep'>
            <svg width="11" height="19" viewBox="0 0 11 19" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd" clip-rule="evenodd" d="M10.1212 18.629C10.6028 18.1343 10.6028 17.3323 10.1212 16.8377L2.97703 9.5L10.1212 2.16234C10.6028 1.66767 10.6028 0.865662 10.1212 0.370999C9.63959 -0.123666 8.85873 -0.123666 8.37711 0.370998L0.360878 8.60433C-0.120742 9.09899 -0.120742 9.901 0.360878 10.3957L8.3771 18.629C8.85872 19.1237 9.63959 19.1237 10.1212 18.629Z" fill="#EDE2E2" />
            </svg>
            Wróć do sklepu
          </Link>
        </ColumnContent>
