            ...
            {arr.map((el, index) => (
              <Link key={el.name + index} className="item" href={el.uri}>
                ...
                <svg width="15" height="25" viewBox="0 0 15 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M1.34836 0.968629C0.740001 1.59347 0.740001 2.60653 1.34836 3.23137L10.3726 12.5L1.34836 21.7686C0.739999 22.3935 0.739999 23.4065 1.34836 24.0314C1.95672 24.6562 2.94307 24.6562 3.55144 24.0314L13.6772 13.6314C14.2856 13.0065 14.2856 11.9935 13.6772 11.3686L3.55144 0.968629C2.94308 0.34379 1.95673 0.34379 1.34836 0.968629Z" fill="#0A0A0A" />
                </svg>
              </Link>
            ))}
          </Results>
